...
export const Listado = ({pacientes,setPaciente,eliminarPaciente}) => {
    ...
    return (
        <div className='md:max-h-[310px] bg-gradient-to-r from-#533747  to-emerald-400 text-white rounded-md mr-10  w-auto lg:w-3/2 xl:w-auto ml-10 p-3  md:h-screen overflow-y-scroll mt-5 sm:mt-0 '>
